...
import { BookOpen, Mail, Lock, Shield, ArrowRight, Loader2, ShieldAlert, Eye, EyeOff, ArrowLeft } from 'lucide-react';
...
const MentorLogin = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-dark-bg text-slate-100 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-accent-secondary/10 rounded-full blur-[120px] -mr-64 -mt-64 pointer-events-none z-0"></div>
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-purple-500/10 rounded-full blur-[120px] -ml-64 -mb-64 pointer-events-none z-0"></div>
        </div>
    );
};
