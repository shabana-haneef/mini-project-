...
import { GraduationCap, Mail, Lock, Shield, ArrowRight, Loader2, ShieldAlert, Eye, EyeOff, ArrowLeft } from 'lucide-react';
    ...
    useEffect(() => {
        if (user) {
            if (user.role === 'student') navigate('/student/dashboard');
                ...
                // To prevent redirect loops, clear invalid sessions
    ...
    return (
        <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-dark-bg text-slate-100 relative overflow-hidden">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-50">
                ...
                <h2 className="text-center text-4xl font-black text-white tracking-tight">Student Portal</h2>
                <p className="mt-3 text-center text-sm text-slate-200 font-medium">
                    New student?{' '}
                    <Link to="/student/signup" className="text-accent-primary hover:text-accent-secondary font-bold underline decoration-accent-primary/30 underline-offset-4 transition-colors">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <button type="submit" disabled={loading} className="w-full relative group pt-2">
                            ...
                            <div className="btn-primary w-full py-4 text-sm">
                                ...
                                {loading ? 'Securing Session...' : 'Enter Student Portal'}
            ...
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-accent-primary/10 rounded-full blur-[120px] -mr-64 -mt-64 pointer-events-none z-0"></div>
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-accent-secondary/10 rounded-full blur-[120px] -ml-64 -mb-64 pointer-events-none z-0"></div>
        </div>
    );
};
